  ...
  if (contactForm) {
    ...
    const validateField = function (field) {
      ...
      if (field.hasAttribute('required') && !validators.required(value)) {
        ...
        errorMessage =
          field.dataset.errorEmail || 'Please enter a valid email address.';
      } else if (
        type === 'tel' &&
        value.trim() !== '' &&
        ...
        errorMessage =
          field.dataset.errorTel || 'Please enter a valid phone number.';
      } else if (
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '23356488-f8ac-406c-a61a-46fda964bc00',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '23356488-f8ac-406c-a61a-46fda964bc00';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '23356488-f8ac-406c-a61a-46fda964bc00';
